...
public class ImageCatalogV4Controller extends NotificationController implements ImageCatalogV4Endpoint {
    ...
    @Override
    @FilterListBasedOnPermissions(action = AuthorizationResourceAction.DESCRIBE)
    ...
    @Override
    @CheckPermissionByResourceName(action = AuthorizationResourceAction.DESCRIBE)
    ...
    @Override
    @CheckPermissionByResourceCrn(action = AuthorizationResourceAction.DESCRIBE)
    ...
    @Override
    @CheckPermissionByResourceName(action = AuthorizationResourceAction.DELETE)
    ...
    @Override
    @CheckPermissionByResourceCrn(action = AuthorizationResourceAction.DELETE)
    ...
    @Override
    @CheckPermissionByResourceNameList(action = AuthorizationResourceAction.DELETE)
