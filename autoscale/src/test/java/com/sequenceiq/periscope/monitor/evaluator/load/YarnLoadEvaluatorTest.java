...
public class YarnLoadEvaluatorTest {
    ...
    public static Stream<Arguments> dataUpScaling() {
        return Stream.of(
                ...
                Arguments.of("SCALE_DOWN_FORCED",  TEST_HOSTGROUP_MAX_SIZE + 10,  5, -10),
    ...
    private Optional<ScalingEvent> captureScalingEvent(int currentHostGroupCount, int yarnUpScaleCount,
        ...
        when(yarnMetricsClient.getYarnMetricsForCluster(any(Cluster.class), anyString(), any(Set.class)))
                .thenReturn(upScale);
